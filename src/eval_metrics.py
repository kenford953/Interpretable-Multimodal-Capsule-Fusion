...
def eval_iemocap(results, truths, single=True):
...
def eval_mosei_senti_or_mosi(results, truths, exclude_zero=True):
    ...
    return mae, corr, mult_a7, mult_a5, f_score, Accuracy
