...
class CapsModel(nn.Module):
    ...
    def forward(self, text, audio, video, batch_size):
        ...
        for r in range(self.routing + 1):
            ...
            if r < self.routing:
                last = rc[3]
                rc[3] = torch.bmm(deci_concat, dc.permute(0, 2, 1))  # inner-product
